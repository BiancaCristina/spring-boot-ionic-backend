...
@Embeddable // Indica que eh um subtipo
public class ItemPedidoPK implements Serializable{
	// Classe auxiliar usada para identificar o item do pedido 
	...
	// HASHCODE AND EQUALS COM BASE TANTO NO PEDIDO QUANTO NO PRODUTO
	@Override
	public int hashCode() {
		final int prime = 31;
		int result = 1;
